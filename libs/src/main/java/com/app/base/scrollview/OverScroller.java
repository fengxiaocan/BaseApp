...
public class OverScroller {
            ...
            int minY, int maxY, int overX, int overY)
    {
        ...
        if (mFlywheel && !isFinished()) {
            ...
            if (Math.signum(velocityX) == Math.signum(oldVelocityX) && Math.signum(velocityY) ==
                                                                       Math.signum(oldVelocityY))
            {
    ...
    public boolean isScrollingInDirection(float xvel, float yvel) {
        ...
        return !isFinished() && Math.signum(xvel) == Math.signum(dx) && Math.signum(yvel) ==
                                                                        Math.signum(dy);
    }
